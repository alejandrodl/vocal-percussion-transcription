...
for part in range(28):
    ...
    np.save('../../data/processed/' + mode + '/test_features_avp_' + mode + '_16_' + str(part).zfill(2), features_16)
...
for part in range(28):
    ...
    np.save('../../data/processed/' + mode + '/train_features_avp_' + mode + '_16_' + str(part).zfill(2), features_16)
...
for part in range(20):
    ...
    np.save('../../data/processed/' + mode + '/test_features_lvt_' + mode + '_32_' + str(part).zfill(2), features_32)
    np.save('../../data/processed/' + mode + '/test_features_lvt_' + mode + '_16_' + str(part).zfill(2), features_16)
...
for part in range(20):
    ...
    np.save('../../data/processed/' + mode + '/train_features_lvt_' + mode + '_32_' + str(part).zfill(2), features_32)
    np.save('../../data/processed/' + mode + '/train_features_lvt_' + mode + '_16_' + str(part).zfill(2), features_16)
