...
modes = ['vae','class','syllall','syllred','phonall','phonred','siamese']
min_acc = [0.58,0.37,0.40,0.58,0.62]
    ...
    for a in range(len(frame_sizes)):
        ...
        for it in range(num_iterations):
            ...
            for part in list_test_participants_avp:
                ...
                if part<=9:
                    train_dataset = np.load('../../data/interim/AVP/Dataset_Train_Aug_0' + str(part) + '.npy')
                    test_dataset = np.load('../../data/interim/AVP/Dataset_Test_0' + str(part) + '.npy')
                else:
                    train_dataset = np.load('../../data/interim/AVP/Dataset_Train_Aug_' + str(part) + '.npy')
                ...
                if part<=9:
                    np.save('../../data/processed/' + mode + '/train_features_avp_' + mode + '_0' + str(part) + '_' + str(it), train_features)
                    np.save('../../data/processed/' + mode + '/test_features_avp_' + mode + '_0' + str(part) + '_' + str(it), test_features)
                else:
                    np.save('../../data/processed/' + mode + '/train_features_avp_' + mode + '_' + str(part) + '_' + str(it), train_features)
                    np.save('../../data/processed/' + mode + '/test_features_avp_' + mode + '_' + str(part) + '_' + str(it), test_features) 

            for part in list_test_participants_lvt:

                if part<=9:
                    train_dataset = np.load('../../data/interim/LVT/Dataset_Train_Aug_0' + str(part) + '.npy')
                    test_dataset = np.load('../../data/interim/LVT/Dataset_Test_0' + str(part) + '.npy')
                else:
                    train_dataset = np.load('../../data/interim/LVT/Dataset_Train_Aug_' + str(part) + '.npy')
                ...
                if part<=9:
                    np.save('../../data/processed/' + mode + '/train_features_lvt_' + mode + '_0' + str(part) + '_' + str(it), train_features)
                    np.save('../../data/processed/' + mode + '/test_features_lvt_' + mode + '_0' + str(part) + '_' + str(it), test_features)
                else:
                    np.save('../../data/processed/' + mode + '/train_features_lvt_' + mode + '_' + str(part) + '_' + str(it), train_features)
                    np.save('../../data/processed/' + mode + '/test_features_lvt_' + mode + '_' + str(part) + '_' + str(it), test_features)  
