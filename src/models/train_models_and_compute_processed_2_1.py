...
param_mode = 'mediumfalsephon55'

if not os.path.isdir('../../data/processed_' + param_mode):
    os.mkdir('../../data/processed_' + param_mode)

if not os.path.isdir('../../models_' + param_mode):
    os.mkdir('../../models_' + param_mode)
...
for m in range(len(modes)):
    ...
    if m==0 or m==1 or m==2 or m==3 or m==4 or m==7:
        continue

    mode = modes[m]

    if not os.path.isdir('../../models_' + param_mode + '/' + mode):
        os.mkdir('../../models_' + param_mode + '/' + mode)

    if not os.path.isdir('../../data/processed_' + param_mode + '/' + mode):
        os.mkdir('../../data/processed_' + param_mode + '/' + mode)
            ...
            for it in range(num_iterations):
                ...
                if mode=='vae':
                    ...
                    while validation_accuracy < min_acc[m-1]:
                        ...
                        early_stopping = tf.keras.callbacks.EarlyStopping(monitor='val_accuracy', patience=patience_early,restore_best_weights=restore_best_weights)
                ...
                model.save_weights('../../models_' + param_mode + '/' + mode + '/pretrained_' + mode + '_' + str(latent_dim) + '_' + str(cv) + '_' + str(it) + '.h5')
                ...
                for part in list_test_participants_avp:
                    ...
                    if part<=9:
                        np.save('../../data/processed_' + param_mode + '/' + mode + '/train_features_avp_' + mode + '_' + str(latent_dim) + '_0' + str(part) + '_' + str(cv) + '_' + str(it), train_features)
                        np.save('../../data/processed_' + param_mode + '/' + mode + '/train_features_aug_avp_' + mode + '_' + str(latent_dim) + '_0' + str(part) + '_' + str(cv) + '_' + str(it), train_features_aug)
                        np.save('../../data/processed_' + param_mode + '/' + mode + '/test_features_avp_' + mode + '_' + str(latent_dim) + '_0' + str(part) + '_' + str(cv) + '_' + str(it), test_features)
                    else:
                        np.save('../../data/processed_' + param_mode + '/' + mode + '/train_features_avp_' + mode + '_' + str(latent_dim) + '_' + str(part) + '_' + str(cv) + '_' + str(it), train_features)
                        np.save('../../data/processed_' + param_mode + '/' + mode + '/train_features_aug_avp_' + mode + '_' + str(latent_dim) + '_' + str(part) + '_' + str(cv) + '_' + str(it), train_features_aug)
                        np.save('../../data/processed_' + param_mode + '/' + mode + '/test_features_avp_' + mode + '_' + str(latent_dim) + '_' + str(part) + '_' + str(cv) + '_' + str(it), test_features) 
                ...
                for part in list_test_participants_lvt:
                    ...
                    if part<=9:
                        np.save('../../data/processed_' + param_mode + '/' + mode + '/train_features_lvt_' + mode + '_' + str(latent_dim) + '_0' + str(part) + '_' + str(cv) + '_' + str(it), train_features)
                        np.save('../../data/processed_' + param_mode + '/' + mode + '/train_features_aug_lvt_' + mode + '_' + str(latent_dim) + '_0' + str(part) + '_' + str(cv) + '_' + str(it), train_features_aug)
                        np.save('../../data/processed_' + param_mode + '/' + mode + '/test_features_lvt_' + mode + '_' + str(latent_dim) + '_0' + str(part) + '_' + str(cv) + '_' + str(it), test_features)
                    else:
                        np.save('../../data/processed_' + param_mode + '/' + mode + '/train_features_lvt_' + mode + '_' + str(latent_dim) + '_' + str(part) + '_' + str(cv) + '_' + str(it), train_features)
                        np.save('../../data/processed_' + param_mode + '/' + mode + '/train_features_aug_lvt_' + mode + '_' + str(latent_dim) + '_' + str(part) + '_' + str(cv) + '_' + str(it), train_features_aug)
                        np.save('../../data/processed_' + param_mode + '/' + mode + '/test_features_lvt_' + mode + '_' + str(latent_dim) + '_' + str(part) + '_' + str(cv) + '_' + str(it), test_features)
